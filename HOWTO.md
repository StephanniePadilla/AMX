# Welcome to Connect Extension project AMXextension
...
**$ docker compose run amxextension_bash**
...
**$ docker compose run amxextension_test**


## Scheduled Methods
In *amxextension/extension.json* file you can find the following section:
```
"schedulables": [
    {
